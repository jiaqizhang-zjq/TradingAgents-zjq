...
from .analysts.candlestick_analyst import create_candlestick_analyst
...
__all__ = [
    ...
    "create_charlie_munger_researcher",
    "create_soros_researcher",
    "create_dalio_researcher",
    "create_livermore_researcher",
