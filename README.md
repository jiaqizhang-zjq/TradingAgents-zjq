...
To use TradingAgents inside your code, you can import the `tradingagents` module and initialize a `TradingAgentsGraph()` object. The `.propagate()` function will return a decision. You can also run `run_trading.py` for a full CLI experience. Here's a quick example:
